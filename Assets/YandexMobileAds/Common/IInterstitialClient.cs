...
namespace YandexMobileAds.Common
{
    public interface IInterstitialClient
    {
        ...
        // Event fired when interstitial is opened.
        event EventHandler<EventArgs> OnInterstitialOpened;

        // Event fired when interstitial is closed.
        event EventHandler<EventArgs> OnInterstitialClosed;

        // Event fired when interstitial is leaving application.
        event EventHandler<EventArgs> OnInterstitialLeftApplication;
