...
namespace YandexMobileAds.Platforms.Android
{
    ...
    {
        public const string AdListenerClassName = "com.yandex.mobile.ads.AdListener";

        public const string AdRequestClassName = "com.yandex.mobile.ads.AdRequest";

        public const string AdRequestBuilderClassName = "com.yandex.mobile.ads.AdRequest$Builder";

        public const string AdSizeClassName = "com.yandex.mobile.ads.AdSize";
        ...
        public const string MobileAdsClassName = "com.yandex.mobile.ads.MobileAds";
        ...
        public static AndroidJavaObject GetAdRequestJavaObject(AdRequest request)
        {
            ...
            {
                adRequestBuilder.Call<AndroidJavaObject>("withContextQuery", request.ContextQuery);
            }

            if (request.ContextTags != null)
			{
                adRequestBuilder.Call<AndroidJavaObject>("withContextTags",
                    stringListToJavaStringArrayList(request.ContextTags));
            }
            
            if (request.Location != null)
            {
                adRequestBuilder.Call<AndroidJavaObject>("withLocation",
            ...
            if (parameters != null)
            {
                adRequestBuilder.Call<AndroidJavaObject>("withParameters",
                    dictionaryToJavaHashMap(parameters));
            }

            if (request.Age != null)
            {
                adRequestBuilder.Call<AndroidJavaObject>("withAge",
                    request.Age);
            }

            if (request.Gender != null)
            {
                adRequestBuilder.Call<AndroidJavaObject>("withGender",
                    request.Gender);
            }
